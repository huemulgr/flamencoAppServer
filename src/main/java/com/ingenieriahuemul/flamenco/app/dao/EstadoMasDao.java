...
public class EstadoMasDao extends BaseDao {
	...
	public List<MasStatusDTO> obtenerEstadoActual() {
		...
		List<MasStatusDTO> lista = (List<MasStatusDTO>) super.ejecutarStoredProcedure(CONSULTA_ESTADO_ACTUAL_APP, in, null,
				MasStatusDTO.class);

		return lista;
	}

	public List<MasStatusDTO> obtenerUsuariosHabilitadosApp() {

		Map<String, Object> in = new HashMap<String, Object>();
		List<MasStatusDTO> lista = (List<MasStatusDTO>) super.ejecutarStoredProcedure(CONSULTA_USUARIOS_HABILITADOS_APP, in, null,
				MasStatusDTO.class);
